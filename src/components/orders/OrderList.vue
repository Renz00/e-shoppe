<template>
    <v-sheet min-height="600">
        ...
        <v-list lines="two" class="py-0 my-0 mx-5 overflow-y-auto" width="auto" max-height="600" v-if="!isLoadingOrders && orders.length>0">
                ...
                <v-row class="">
                    <v-col class="pa-3 pa-sm-5" cols="12" sm="9">
                        <v-container class="">
                            ...
                            <v-row class="my-0">
                                <v-col cols="12" class="text-body-2 py-0"><span class="text-subtitle-2">Estimated Arrival: </span><span class="text-body-2">{{ order.order_eta }}</span></v-col>
                            </v-row>
                        </v-container>
                    </v-col>
